...
**当前版本：v1.2.3** · **当前维护仓库：** [ViVi141/arma3-server-tool](https://github.com/ViVi141/arma3-server-tool)
...
详见 **[docs/release-v1.2.3.md](docs/release-v1.2.3.md)**（历史：[v1.2.2](docs/release-v1.2.2.md)、[v1.2.1](docs/release-v1.2.1.md)、[v1.2.0](docs/release-v1.2.0.md)、[v1.1.1](docs/release-v1.1.1.md)、[v1.1.0](docs/release-v1.1.0.md)、[v1.0.0](docs/release-v1.0.0.md)）。
