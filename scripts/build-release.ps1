...
$SetupFileName = "Arma3ServerTools-Setup.exe"
...
if (-not $SkipInstaller) {
    ...
    Write-InnoBuildMetadata -Version $Version -VersionInfo $VersionInfo -Copyright $AppCopyright -PublishDir $PublishDir | Out-Null
    ...
    if (-not (Test-Path $SetupPath)) {
        throw "Installer build finished but $SetupFileName was not created: $SetupPath"
    }
}
